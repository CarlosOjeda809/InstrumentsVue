...
<template>
  <div class="flex items-center justify-center min-h-screen bg-gray-900 p-6">
    <div class="bg-gray-800 p-8 rounded-lg shadow-2xl w-full max-w-xl">
      ...
      <form @submit.prevent="insertarDatosUser" class="flex flex-col space-y-5 mt-8">
        <input v-model="nombreUser" type="text" placeholder="Nombre"
          ...
          :disabled="!signup" /> <input v-model="correoUser" type="email" placeholder="Email"
          class="w-full p-3 bg-gray-700 text-white rounded-md border-2 border-gray-600 focus:outline-none focus:border-yellow-500 focus:ring-1 focus:ring-yellow-500 transition duration-200 placeholder-gray-400"
           :disabled="!signup" /> <input v-model="contraseñaUser" type="password" placeholder="Password"
          class="w-full p-3 bg-gray-700 text-white rounded-md border-2 border-gray-600 focus:outline-none focus:border-yellow-500 focus:ring-1 focus:ring-yellow-500 transition duration-200 placeholder-gray-400"
           :disabled="!signup" /> <button type="submit"
